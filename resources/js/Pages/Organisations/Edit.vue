  ...
  <div>
    ...
    <div class="mt-6 bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="collaborateur in organisation.collaborateurs" :key="collaborateur.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
        ...
        <tr v-if="organisation.collaborateurs.length === 0">
